...
class MyTestCase(unittest.TestCase):
    def setUp(self):
        self.pranala = Pranala(2)

    def test_zero(self):
        """Test 0 multiplied by 2"""

        # 0 multiplied by 2 return 0
        result = self.pranala.multiply(0)
    ...
    def test_natural_number(self):
        ...
        result = self.pranala.multiply(5)
    ...
    def test_integer_number(self):
        ...
        result = self.pranala.multiply(-7)
    ...
    def test_rational_number(self):
        ...
        result = self.pranala.multiply(6/17)
    ...
    def test_real_number(self):
        ...
        result = self.pranala.multiply(math.pi)
